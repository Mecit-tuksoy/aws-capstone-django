...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/mecit/capstone/username')
    password_param = ssm.get_parameter(Name="/mecit/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.ceua3bb7mpat.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'mecitcapstonestatic' # please enter your s3 bucket name
